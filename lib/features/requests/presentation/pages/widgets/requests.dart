...
class _Body extends StatelessWidget {
  ...
  const _Body({required this.users, required this.isSearching});
  ...
  Widget build(BuildContext context) {
    ...
    if (users.isEmpty) {
      return Empty(
        ...
        imagePath: 'assets/images/empty_requests.png',
        message: s.requestsEmpty,
        searchMessage: s.requestsEmptySearch,
      );
    }
